<<<<<<< Updated upstream:php/Completed Builds.php
﻿<!DOCTYPE html>
=======
<!DOCTYPE html>
>>>>>>> Stashed changes:html/Completed Builds.html
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>    
    <div class="header">
        <div class="container">
            <img class="logo" src="../images/Cadi Logo.png" alt="logo">
            <div class="links">
                <span class="icon">
                    <span></span>
                    <span></span>
...
<<<<<<< Updated upstream:php/Completed Builds.php
                    ...
                    <li><a href="../html/Completed Builds">Completed Builds
                        <i class="fa-solid fa-computer"></i>
                    </a></li>
                    <li><a href="../html/contact.html">Contact
=======
                    <li><a href="#Builder">Builder 
                        <i class="fa-solid fa-screwdriver-wrench"></i>
                    </a></li>
                    <li><a href="#Build Guides">Build Guides
                        <i class="fa-sharp fa-solid fa-book"></i>
                    </a></li>
                    <li><a href="#Completed Builds">Completed Builds
                        <i class="fa-solid fa-computer"></i>
                    </a></li>
...
<<<<<<< Updated upstream:php/Completed Builds.php
    <section class="builds">
        <h1>Our Completed Builds</h1>
        <p>Here You Get to Choose Between Some of Our High-End Completed Builds.</p>
=======
...
<<<<<<< Updated upstream:php/Completed Builds.php
                        <img src="../images/Completed Build 4.png" class="images4"> 
                        <div class="layer">
                        <h3>Cadi</h3>
=======
                        <div class="dis">
...
=======
    <script src="Completed Builds.js"></script>
>>>>>>> Stashed changes:html/Completed Builds.html
</body>
</html>
    ...
    <div class="components">
        <div class="container">
            <div class="feat">
                ...
                <p><a href="../php/cpu.php" class="link"><img src="../images/cpu2.jpg" alt="CPU" class="img_l"></a> </p>
            </div>
            <div class="feat">
                <h3><a href="../php/gpu.php" class="link">Graphics Processing Unit</a></h3>
                <p><a href="../php/gpu.php" class="link"><img src="../images//gpu2.jpg" alt="GPU" class="img_l"></a> </p>
            </div>
            <div class="feat">
                <h3><a href="../php/motherboard.php" class="link">Motherboard</a></h3>
                <p><a href="../php/motherboard.php" class="link"><img src="../images/motherboard.png" alt="CPU" class="img_l"></a> </p>
            </div>
            <div class="feat">
                <h3><a href="../php/case.php" class="link">Case</a></h3>
                <p><a href="../php/case.php" class="link"><img src="../images/case2.jpg" alt="CPU" class="img_l"></a> </p>
            </div>
            <div class="feat">
                <h3><a href="../php/memory.php" class="link">Memory</a></h3>
                <p><a href="../php/memory.php" class="link"><img src="../images/ram.jpg" alt="CPU" class="img_l"></a> </p>
            </div>
            <div class="feat">
                <h3><a href="../php/storage.php" class="link">Storage</a></h3>
                <p><a href="../php/storage.php" class="link"><img src="../images/ssd.jpg" alt="CPU" class="img_l"></a> </p>
            </div>
            <div class="feat">
                <h3><a href="../php/lapguide.php" class="link">Laptops</a></h3>
                <p><a href="../php/lapguide.php" class="link"><img src="../images/laptop1.jpg" alt="Laptops" class="img_l"></a> </p>
            </div>
        </div>
    </div>
    <!-- End main Components -->
